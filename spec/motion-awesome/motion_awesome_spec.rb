describe MotionAwesome do
  ...
  describe "#label" do
    ...
    it "builds a text label with all the fixins correctly" do
      ...
      comp.text.should == "\xEF\x80\xA4 Bozo!"
      attrd = comp.attributedText
      attrd.string.should == "\xEF\x80\xA4 Bozo!"

      attrd.enumerateAttributesInRange( (0...1),
      ...
      attrd.enumerateAttributesInRange( (2..attrd.string.size-1),
        options:NSAttributedStringEnumerationReverse,
        usingBlock:->(attrs, range, stop) {
  ...
  describe '#button' do
    ...
    it "builds a button with all the fixins correctly" do
      ...
      attrd = comp.attributedTitleForState(UIControlStateNormal)
      attrd.string.should == "\xEF\x80\xA4 Bozo!"
